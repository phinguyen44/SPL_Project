...
```{r echo = FALSE, eval = TRUE, error = FALSE, warning = FALSE, message = FALSE, comment= FALSE}
# SOURCE DATA
invisible(capture.output(source("Scripts/ReadAndClean.R")))
invisible(capture.output(source("Scripts/ProbitRegression.R")))
invisible(capture.output(source("Scripts/LoadWald.R")))
...
``` 
```{r echo = FALSE, eval = TRUE, error=TRUE, warning = FALSE,message = FALSE, comment= FALSE}
# SOURCE DATA
invisible(capture.output(source("Scripts/ReadAndClean.R")))
invisible(capture.output(source("Scripts/LoadWald.R")))
invisible(capture.output(source("Scripts/ProbitRegression.R")))
...
``` 
```{r echo=FALSE, eval = TRUE, results = "asis", warning = FALSE, message = FALSE, comment= FALSE}
invisible(capture.output(source("Scripts/ReadAndClean.R")))
