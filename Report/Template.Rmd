...
Among the selected countries, France, the Netherlands and Belgium have the fewest laborers among the oldest age group, which is ranging from 60 to 64 years. In the middle age group, ranging from 54-59, the Belgian and Italian population have sparse labor participation rates among men and women. Within the youngest age group including people from 50 to 54 years old, variance among men is generally low. This is not the case for Greek, Italian and Spanish women, whose participation rates do not exceed 45.5%. 
...
Probit models allow for the estimation of binary, random response variables.  
...
Using this model, it is investigated how the probability of labor participation is influenced by health and age variables. 

We are especially focussing on the calculation and evaluation of marginal effects.
...
These main results are validated by the analysis. As shown on the example below, which is a summary of the probability of Austrian women participating in the labor market as explained by the probit model, age and the prevalence of chronic diseases are negatively related to employment. Analysis of the marginal effects show, that the negative influence of age on the dependent variable is growing with increasing age. Conversely, high education positively predicts labor force participation for the specified group. Having children does not significantly influence the independent variable. These results are stable across different groups. 

Comparing the marginal effects between our results and the paper by @kalwij2005labour shows similar results. Usually, significant coefficient estimates as well as their significance level are close to each other. However, as the data sets differ, there are deviations in the majority of models. This rarely affects the sign of the coefficients. 


```{r, eval = TRUE, results = 'asis', echo = FALSE, message = FALSE, warning = FALSE}

library("xtable", quietly = TRUE)
xtable::xtable( allSummaries[[1]], caption = "Probability of Austrian women participating in the labor market")
